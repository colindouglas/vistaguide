...
## Asking Too Much
Top `r rows_print` overvalued properties with a list date in the last two weeks
...
## MAD DEALZ
Top `r rows_print` undervalued properties with a list date in the last two weeks
